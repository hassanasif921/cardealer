...
<ul>  <!-- SLIDE  -->
    ...
    <!-- MAIN IMAGE -->
        <img src="revolution/assets/3ecde-01.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
    <!-- LAYERS -->
...
not even close to us </div>
  ...
  <!-- SLIDE  -->
    ...
    <!-- MAIN IMAGE -->
        <img src="revolution/assets/ac5dd-02.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
    <!-- LAYERS -->
...
<section class="welcome-3 white-bg page-section-ptb">
  <div class="container">
    ...
    <div class="row about custom-block-2">
      <div class="col-md-6">
        <h2>About us </h2>
        <span>AAR JAPAN would be obliged that if you invest some time with us and visit our website.</span> 
        <p>The
objective of our company is to provide you with an extensive and co-related tour of our new
and used Japanese cars inventory, as well as give you the opportunity to easily get a quote,
book a car or apply for online auction services. Undoubtedly the search for a luxury car is filled
with high hopes which has lot to do, with the detailed search and all the possible options with
us. We understand high expectations for the dealership.</p>
      </div>
      <div class="col-md-6">
 ...
 <div class="row">
  <div class="col-md-12">
   <div class="owl-carousel owl-theme" data-nav-dots="true" data-items="3" data-md-items="3" data-sm-items="2" data-xs-items="1" data-space="15">
     ...
     <?php 
     $query=mysqli_query($conn,"SELECT * FROM `cardetails` ORDER BY C_id DESC LIMIT 8");
...
var index = 1;
window.location = 'carlisting.php?brand=' + select + '&model=' + selectmodel + '&year=' + selectyear + '&stockid=' + stockid +  '&year=' + selectyear;
